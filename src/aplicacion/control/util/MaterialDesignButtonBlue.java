 ...
 * @author Yornel
 */
public class MaterialDesignButtonBlue extends Button {
    ...
    public MaterialDesignButtonBlue(String text) {
        super(text);
        getStyleClass().addAll("md-button");
        createRippleEffect();
        setStyle("-fx-background-color: #039BE5; "
                + "-fx-text-fill: white;");
        setMinHeight(25);
        setMaxWidth(90);
