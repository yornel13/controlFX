 ...
 * @author Yornel
 */
public class ClientesParaRolesController implements Initializable {
    ...
    private void mostrarEmpleadosSinCliente(ActionEvent event) {
        aplicacionControl.mostrarRolCliente(empresa, null, stagePrincipal);
    }
        ...
        clientesTableView.setRowFactory( (Object tv) -> {
            ...
            row.setOnMouseClicked(event -> {
                if (event.getClickCount() == 2 && (! row.isEmpty()) ) {
                    ...
                    aplicacionControl.mostrarRolCliente(empresa, rowData, stagePrincipal);
                }
            });
            return row ;
        });
