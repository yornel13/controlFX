 ...
 * @author Yornel
 */
public class ClientesParaBonosController implements Initializable {
    ...
    private void mostrarEmpleadosSinCliente(ActionEvent event) {
        aplicacionControl.mostrarBonosEmpleados(empresa, null, stagePrincipal);
    }
        ...
        clientesTableView.setRowFactory( (Object tv) -> {
            ...
            row.setOnMouseClicked(event -> {
                if (event.getClickCount() == 2 && (! row.isEmpty()) ) {
                    ...
                    aplicacionControl.mostrarBonosEmpleados(empresa, rowData, stagePrincipal);
                }
            });
            return row ;
        });
